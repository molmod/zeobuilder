...
class Arrow(Vector, ColorMixin):
    ...
    dialog_fields = set([
        ...
        DialogFieldInfo("Geometry", (2, 3), fields.faulty.Length("Invalid arrow length.", "Arrow length", "arrow_length", low=0.0)),
        DialogFieldInfo("Geometry", (2, 4), fields.faulty.Length("Invalid arrow radius.", "Arrow radius", "arrow_radius", low=0.0, low_inclusive=False)),
        DialogFieldInfo("Geometry", (2, 5), fields.faulty.Float("Invalid arrow position.", "Arrow position", "arrow_position", low=0.0, high=1.0)),
