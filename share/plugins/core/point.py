...
class Point(GLGeometricBase, ColorMixin):
    ...
    dialog_fields = set([
        DialogFieldInfo("Geometry", (2, 7), fields.faulty.Length("Invalid spike length.", "Spike length", "spike_length", low=0.0, low_inclusive=False)),
        DialogFieldInfo("Geometry", (2, 8), fields.faulty.Length("Invalid spike thickness.", "Spike thickness", "spike_thickness", low=0.0, low_inclusive=False))
    ])
