...
class CoreActions(ApplicationTestCase):
    ...
    def test_rotate_dialog(self):
        def fn():
            ...
            parameters.rotation.set_rotation_properties(130, numpy.array([0.1, 1.4, 0.3]), False)
    ...
    def test_rotate_around_center_dialog(self):
        def fn():
            ...
            parameters.complete.set_rotation_properties(130, numpy.array([0.1, 1.4, 0.3]), False)
